...
class System_SharedMemory_Sqlite extends System_SharedMemory_Common
{
    ...
    */
    ...
    // }}}
	function isVar($name) { // oneye
		$sql = 'SELECT ' . $this->_options['value'] . ' FROM ' . $this->_options['table'] . ' WHERE ' . $this->_options['var'] . '=\'' . sqlite_escape_string($name) . '\' LIMIT 1';
		return (sqlite_num_rows(sqlite_query($this->_h, $query)) > 0);
	}
}
// }}}
?>