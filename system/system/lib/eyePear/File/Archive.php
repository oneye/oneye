...
class File_Archive
{
    ...
    {
        // oneye
        $eqTypes = File_Archive::getOption('eqTypes');
        return isset($eqTypes[strtolower($extension)]) ||
               $extension == 'tar'   ||
               $extension == 'zip'   ||
               $extension == 'jar'   ||
               $extension == 'gz'    ||
    ...
    function readArchive($extension, &$toConvert, $sourceOpened = false)
    {
        ...
        if (isset($eqTypes[$extension]) === true) {
            $extension = strtolower($eqTypes[$extension]);
        }
...
/*        case 'cab':
                       ...
                       $stat = array(), $autoClose = true)
    {
        ...
        foreach ($extensions as $key => $value) {
            if (isset($eqTypes[$value]) === true) {
                $extensions[$key] = strtolower($eqTypes[$value]);
            }
        }
